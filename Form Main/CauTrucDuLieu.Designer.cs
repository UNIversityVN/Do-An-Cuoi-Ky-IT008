namespace Form_Main
{
    partial class CauTrucDuLieu
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.TabIndex = 0;
            label1.Text = "DataStructure";
            label1.TextAlign = ContentAlignment.MiddleCenter;
            // 
            // button_setting
            // 
            button_setting.BackColor = Color.FromArgb(27, 30, 33);
            button_setting.FlatAppearance.BorderSize = 0;
            button_setting.FlatAppearance.MouseDownBackColor = SystemColors.Control;
            button_setting.FlatAppearance.MouseOverBackColor = Color.FromArgb(45, 45, 45);
            button_setting.FlatStyle = FlatStyle.Flat;
            button_setting.Font = new Font("Tahoma", 10.8F, FontStyle.Regular, GraphicsUnit.Point, 0);
            button_setting.ForeColor = Color.White;
            button_setting.Image = (Image)resources.GetObject("button_setting.Image");
            button_setting.Location = new Point(0, 505);
            button_setting.Name = "button_setting";
            button_setting.Size = new Size(160, 80);
            button_setting.TabIndex = 11;
            button_setting.Text = "Settings";
            button_setting.TextImageRelation = TextImageRelation.ImageBeforeText;
            ...
            panel_Tool.Controls.Add(button_setting);
            ...
            button_user.Location = new Point(-2, 591);
            button_user.Name = "button_user";
            button_user.Size = new Size(160, 61);
            button_user.TabIndex = 17;
            button_user.Text = "Account";
